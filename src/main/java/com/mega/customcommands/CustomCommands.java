package com.mega.customcommands;

import org.slf4j.Logger;

import com.mojang.logging.LogUtils;
import com.mega.customcommands.command.ModCommands;
...
public class CustomCommands {
    ...
    public static final String MODID = "customcommands";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "customcommands" namespace
    ...
    public CustomCommands(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (CustomCommands) to respond directly to events.
    ...
    private void commonSetup(FMLCommonSetupEvent event) {
        ...
        LOGGER.info("Custom Commands mod initialized");
    }
